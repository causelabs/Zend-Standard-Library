...
*/
class HiDef_Validate_DateCompare extends Zend_Validate_Abstract
{
	/**
	* Error codes
	* @const string
	...
	*
	* @param  mixed $token
	* @return HiDef_Validate_DateCompare
	*/
	...
	*/
	public function isValid($value)
	{
		...
		$date1 = new Zend_Date(strtotime($value));
		$date2 = new Zend_Date(strtotime($token));
